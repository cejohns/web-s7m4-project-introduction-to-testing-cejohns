...
import App from './App'
import txt from '../il8n/index.json'
...
describe('Module 4 Project Tests', () => {
  ...
  const { getEntriesByKeyPrefix } = require('./helperFunctions');
  ...
  describe('getEntriesByKeyPrefix', () => {
    ...
    */
    ...
    test('can extract the correct data with "xyz" prefix', () => {
      const obj = {
        abc_1: 'data_abc_1',
        abc_2: 'data_abc_2',
        xyz_1: 'data_xyz_1',
    ...
    test('returns an empty array for a non-existent prefix "foo"', () => {
      const obj = {
        abc_1: 'data_abc_1',
        abc_2: 'data_abc_2',
        xyz_1: 'data_xyz_1',
...
module.exports = { getEntriesByKeyPrefix };